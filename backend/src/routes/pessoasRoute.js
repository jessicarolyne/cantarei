...
router.get('/pessoas/:pessoaId/grupos', (req, res) => pessoaController.buscarGrupos(req, res));
router.get('/pessoas/:pessoaId/salmos', (req, res) => pessoaController.buscarSalmos(req, res));
router.post('/pessoas/:pessoaId/salmos', (req, res) => SalmoController.criarNovoRegistro(req, res));
